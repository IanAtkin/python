...
class Card:
    ...
    def __init__(self, suit, value, canvas):
        ...
        text = "%s  %s" % (suit, VALNAMES[value])
        self.__text = CanvasText(canvas, CARDWIDTH//2, 0,
                               anchor=N, fill=self.color, font=("Purisa", 32), text=text)
...
class Deck(Stack):
    ...
    def userclickhandler(self):
        #print "%s %s" % ('cards', len(self.cards))
...
class Solitaire:
    ...
    def __init__(self, master):
        ...
        self.canvas = Canvas(self.master,
                             ...
                             height=STACKSPACING*YSPACING + 20 + MARGIN)
        ...
        self.dealbutton = Button(self.canvas,
                                 ...
                                 command=self.deal)
        Window(self.canvas, MARGIN, STACKSPACING*YSPACING + 20,
